...
export const AppText={
   ...
   Iam:'I am ',
   RahulSanap:'Arup Roy',
   aboutMeDescripion:'I am software developer working in IT industry from  last 3 Years as Full stack developer. Expert in UI/UX design, Front-end  and Back-end Development',
   About: 'About',
   Me: ' Me',
   Skills:'Skills & ',
   Experties:'Experties',
   ...
   Contact:'Contact ',
   Us:'Us',
   copywriteText:'Copyright by Arup Roy @2023'
